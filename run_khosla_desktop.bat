...
set "APP_FILE=%~dp0khosla_desktop_app.py"
...
if not exist "%APP_FILE%" (
  echo ERROR: khosla_desktop_app.py was not found in this folder.
  echo Folder: %CD%
  > "%LOG_FILE%" echo ERROR: khosla_desktop_app.py was not found in this folder.
