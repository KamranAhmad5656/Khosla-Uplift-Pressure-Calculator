...
if exist khosla_desktop_app.py (echo OK khosla_desktop_app.py) else echo MISSING khosla_desktop_app.py
if exist khosla_desktop_app.pyw (echo OK khosla_desktop_app.pyw) else echo MISSING khosla_desktop_app.pyw
